...
mf_dr_mc.fit_with_dataloader(train_loader, impute_loader,
    lr=0.05,
    lamb=1e-4,
    tol=1e-5,
    verbose=True)

res = evaluate_func(mf_dr_mc, test_dataset)

print("***"*5 + "[MF-DR-MC]" + "***"*5)
print("[MF-DR-MC] test mse:", res["mse"])
print("[MF-DR-MC] test auc:", res["auc"])
